...
/// Stand-in for an uploaded asset's storage path. Asset paths embed the project
/// id, so real code passes `uploaded.storagePath` from `sdk.assets.uploadFile`
  ...
  app.page(
    ...
    body: Scaffold(
      ...
      body: Column(
        ...
        crossAxis: CrossAxis.center,
        children: [
          // Asset-sourced widgets take an uploaded asset's STORAGE PATH —
          // what `sdk.assets.uploadFile(projectId, File('hero.riv'))` returns
          // as `.storagePath`. It is never a Flutter bundle path: FlutterFlow
          // generates `assets/rive_animations/...` itself at build time.
          Rive(
            '$_kAssetPrefix/hero.riv',
